		...
		<div class="">
			...
			<div class="bg-white rounded-sm shadow-sm mb-6 p-6">
				<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
					<div>
						<h1 class="text-2xl font-bold text-gray-900 mb-2">Doctor Reviews</h1>
						<p class="text-gray-600">
							Manage and respond to patient reviews of doctors
						</p>
					</div>
				...
				<div class="lg:col-span-1">
					<div class="bg-white rounded-sm shadow-sm p-6 sticky top-6">
						...
						<p class="text-sm text-gray-600 mb-6">
							Overview of doctor reviews and ratings
						</p>
				...
				<div class="lg:col-span-3">
					...
					<div class="space-y-4">
						...
						>
							...
							<!-- Doctor Response -->
							<div v-if="review.response" class="bg-gray-50 rounded-sm p-4 mb-4">
								<p class="text-sm font-medium text-gray-900 mb-2">
									Response from {{ review.doctor }}
								</p>
							...
							>
								...
								<span class="text-sm text-gray-500"
									>Department: {{ review.department }}</span
								>
							</div>
						</div>
					</div>
...
const reviews = ref([
	...
	},
	{
		...
		date: '10/04/2023',
		verified: true,
		doctor: 'Dr. Robert Chen (Neurologist)',
...
const filteredReviews = computed(() => {
	return reviews.value.filter((review) => {
		const matchesSearch =
			...
			review.doctor.toLowerCase().includes(searchQuery.value.toLowerCase())
		...
		const matchesDepartment =
			...
			review.department.toLowerCase() === selectedDepartment.value.toLowerCase()
